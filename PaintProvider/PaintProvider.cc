...
ETCS_TAG_BLOCK_BASIC(PaintDocument,
    ...
    ExportOps, ExportBaseline, ImportOps, NotebookHead, PictureHash, PictureReport, Accept, Perform, RevertPending, SetAuthor, SetReadOnly,
...
ETCS_TAG_BLOCK_HYBRID(PaintInput,
    (Create, BindDocument, BindTool, BindSurface, SetBrush,
     BindRoot, BindCanvas, BindPalette, BindPanel, BindPagePanel, BindVisitors, BindTextBar, Undo, Redo, RedoAlt, BindRedoAlt, BindAnimation, BindGlyphs, SetHoldCapacity, BindPages,
